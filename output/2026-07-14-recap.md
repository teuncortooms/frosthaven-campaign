...
Regenerate: `python scripts/generate-recap.py` (from `exports\2026-07-14-storyline.json`) → `output/2026-07-14-recap.html` for sharing. See `data/campaign-notes.md`.
